      ...
      {focused && (
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <button
              className="w-21 h-8 bg-blue-600 dark:bg-blue-700 text-white rounded-md cursor-pointer enabled:hover:bg-blue-700 enabled:dark:hover:bg-blue-600 enabled:active:scale-98 enabled:active:opacity-70 disabled:cursor-not-allowed disabled:opacity-70 transition-all duration-200"
